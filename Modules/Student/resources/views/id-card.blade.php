...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .id-no { font-size: 9px; font-weight: bold; color: #4f46e5; margin-top: 4px; }
            ...
            <table class="row">
                <tr>
                    ...
                    <td style="vertical-align: top; padding-left: 6px;">
                        ...
                        <div class="meta">
                            @if($person['class'])<div>Class: {{ $person['class'] }}</div>@endif
                            @if($person['batch'])<div>Batch: {{ $person['batch'] }}</div>@endif
                            @if($person['session'])<div>Session: {{ $person['session'] }}</div>@endif
