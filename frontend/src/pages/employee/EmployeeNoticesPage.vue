<template>
  <div class="employee-page">
    <div class="page-header">
      <h1>Notice Board</h1>
      <p>Organization announcements and important updates</p>
    </div>
...
export default {
  ...
  setup() {
    ...
    const loadNotices = async () => {
      ...
      error.value = null
      try {
        const res = await employeePortalService.notices()
...
<style scoped>
.employee-page { max-width: 900px; margin: 0 auto; }
